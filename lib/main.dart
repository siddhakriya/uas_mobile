...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: AppColor().colorFourth,
      ),
      home: HomeScreen(),
    );
  }
        ...
        onPressed: () async {
          ...
          if (result != null && result) {
            scaffoldState.currentState.showSnackBar(SnackBar(
              content: Text('Penjualan Telah Dibuat'),
            ));
            setState(() {});
          }
        },
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Card(
                      child: ListTile(
                        ...
                        subtitle: Text(
                          'Total Pembelanjaan : Rp.' + formatted,
                          maxLines: 1,
                        ...
                        trailing: PopupMenuButton(
                          ...
                          onSelected: (String value) async {
                            if (value == 'edit') {
                              ...
                              if (result != null && result) {
                                scaffoldState.currentState.showSnackBar(SnackBar(
                                  content: Text('Pembelanjaan Telah Diupdate'),
                                ));
                                setState(() {});
                              }
